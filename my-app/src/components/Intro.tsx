...
const Intro: React.FC = () => {
    return (
        <div className="intro" id={`${SectionButton.Home}`}>
            <div className="intro_foto_contact_container" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
            ...
            <div className="intro_text_container" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">
                <h1>
